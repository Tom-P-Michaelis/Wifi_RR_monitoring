...
h = plot(cAH, l, l, ':', 'Linewidth', 2); set(h,'color',[1 0 0],'tag','IdentityLine');
...
switch upper(params.baStatsMode)
	case {'NORMAL','GAUSSIAN'}
		plot(baAH,a(1:2),stats.differenceMean+[0 0],'r', 'LineWidth', 2)
		plot(baAH,a(1:2),stats.differenceMean+stats.rpc*[1 1],':r', 'LineWidth', 2)
		plot(baAH,a(1:2),stats.differenceMean-stats.rpc*[1 1],':r', 'LineWidth', 2)
	...
	case 'NON-PARAMETRIC'
		plot(baAH,a(1:2),stats.differenceMedian+[0 0],'r', 'LineWidth', 2)
		plot(baAH,a(1:2),stats.differenceMedian+stats.rpcNP*[1 1],':r', 'LineWidth', 2)
		plot(baAH,a(1:2),stats.differenceMedian-stats.rpcNP*[1 1],':r', 'LineWidth', 2)
		text(a(2),stats.differenceMedian+stats.rpcNP, [mynum2str(stats.differenceMedian+stats.rpcNP,2) '(brpm)'],'Parent',baAH,'HorizontalAlignment','left','VerticalAlignment','bottom','fontsize',fontsize,'Tag','ULimLabel');
		text(a(2),stats.differenceMedian,[mynum2str(stats.differenceMedian,2) ' (brpm)'],'Parent',baAH,'HorizontalAlignment','left','VerticalAlignment','middle','fontsize',fontsize,'Tag','MeanLabel');
		text(a(2),stats.differenceMedian-stats.rpcNP, [mynum2str(stats.differenceMedian-stats.rpcNP,2) '(brpm)'],'Parent',baAH,'HorizontalAlignment','left','VerticalAlignment','top','fontsize',fontsize,'Tag','LLimLabel');
		if isGaussian(stats) 
